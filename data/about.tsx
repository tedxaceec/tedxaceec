...
export const COLLEGE = {
    ...
    description: "ACE Engineering College is a premier institution of higher learning located in Ankushapur, Ghatkesar, Hyderabad, Telangana, India. Established with a vision to nurture innovation and academic excellence, the college has been at the forefront of engineering education, producing world-class engineers and innovators.\n\nWith state-of-the-art infrastructure, dedicated faculty, and a vibrant campus culture, ACE Engineering College provides a nurturing environment that encourages students to think beyond boundaries and create meaningful impact. The college is NAAC accredited and affiliated to JNTUH, offering a range of undergraduate and postgraduate programs in engineering and technology.\n\nTEDxACEEC is a proud extension of this legacy — a platform where the spirit of innovation meets the power of ideas worth spreading at ACE Engineering College, Ghatkesar, Telangana.",
    stats: [
